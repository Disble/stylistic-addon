...
describe("CommentCleanup", () => {
  ...
  it("classifies only overlapping Word location relations as colocated", () => {
    expect(isOverlappingRelation("Equal")).toBe(true);
    expect(isOverlappingRelation("Contains")).toBe(true);
    expect(isOverlappingRelation("Inside")).toBe(true);
    expect(isOverlappingRelation("OverlapsBefore")).toBe(true);
    expect(isOverlappingRelation("OverlapsAfter")).toBe(true);
    expect(isOverlappingRelation("AdjacentBefore")).toBe(false);
  });
});

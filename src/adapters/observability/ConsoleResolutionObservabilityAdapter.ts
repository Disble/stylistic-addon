...
export class ConsoleResolutionObservabilityAdapter implements IResolutionObservabilityPort {
  ...
  async captureSnapshot(snapshot: ResolutionObservabilitySnapshot): Promise<void> {

...
export class NoopResolutionObservabilityAdapter implements IResolutionObservabilityPort {
  ...
  async captureSnapshot(_snapshot: ResolutionObservabilitySnapshot): Promise<void> {
    return undefined;
  }
}
